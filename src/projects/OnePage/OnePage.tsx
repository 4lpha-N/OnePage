...
function HomeContent() {
  return (
    <div>
      ...
      <Grid container spacing={4}>
            <Grid size={{ xs: 12, sm: 6, md: 6, lg: 6, xl: 6 }} style={{backgroundColor: 'crimson'}} display={'block'}>
              <span>Col 1</span>
            </Grid>
            <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3, xl: 2 }} offset={{ xs: 0, md: 2, lg: 3, xl: 4 }} style={{backgroundColor: 'crimson'}}>
              <span>Col 2</span>
            </Grid>
        </Grid>
    </div>
